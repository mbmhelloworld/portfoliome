    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'Webdeveloper', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
            ...
            [
                ...
                'class' => '', // any class for input
                'value' => '<a href="" class="text-muted">Built with ♥</a>', // default value if you want
            ],
            [
    ...
    'meta' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'This is my Website.', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
